...
public class Cubo { //matriz de 3 dimensiones: la primera para decirme que cara es, la segunda y tercera son las dimensiones de la cara.
	//IDENTIFICADORES DE CARAS QUE SERIAN LOS COLORES (tienen que ser short ha dicho el profe xd)
